    ...
    <div class="category-container">
        ...
        <form action="{{ route('categories.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="color" name="color" id="color" value="{{ old('color', '#007bff') }}" onchange="updatePreview()">
                <div class="color-preview" id="colorPreview" style="background-color: {{ old('color', '#007bff') }};"></div>
                @error('color')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
